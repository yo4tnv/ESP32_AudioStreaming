...
String htmlHeader() {
  ...
  s += F("<title>ESP32 WAV + BMP280</title>");
  s += F("<style>body{font-family:system-ui,Segoe UI,Roboto,Arial;margin:16px} .card{border:1px solid #ddd;border-radius:12px;padding:16px;margin:12px 0;box-shadow:0 2px 6px rgba(0,0,0,.06)} code{background:#f5f5f5;padding:2px 6px;border-radius:6px}</style>");
  s += F("</head><body>");
